...
class SendEmailUpdatesCommandApr30 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'email:match-updates-apr30 {--fromid= : User id to start from} {--toid= : User id to end at}';
     ...
     * @var string
     */
    protected $description = 'Sends updates with whatsapp CTA (only for non-hotmail)';
    ...
    {
        $this->lastSentAt = Carbon::parse('2018-04-28 15:20:10');
