...
use Carbon\Carbon;
class SendEmailUpdatesCommandApr20Failed extends Command
{
     ...
     * @var string
     */
    protected $signature = 'email:match-updates-apr20-failed {--fromid= : User id to start from} {--toid= : User id to end at}';
     ...
     * @var string
     */
    protected $description = 'Sends updates without undirabu stuff';
