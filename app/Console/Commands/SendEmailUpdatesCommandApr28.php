...
use Carbon\Carbon;
class SendEmailUpdatesCommandApr28 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'email:match-updates-apr28 {--fromid= : User id to start from} {--toid= : User id to end at}';
    ...
    {
        $this->lastSentAt = Carbon::parse(\App\Models\EmailsSent::find(29)->sent_at); //using 1 because of the matching bug :(
