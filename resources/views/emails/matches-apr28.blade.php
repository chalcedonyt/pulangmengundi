                      ...
                      <div class="">
                        ...
                        <div style="line-height:120%;color:#0D0D0D;font-family:Verdana; padding-right: 50px; padding-left: 50px; padding-top: 50px; padding-bottom: 5px;">
                          <div style="font-size:12px;line-height:14px;color:#0D0D0D;font-family:Verdana;text-align:left;">
                            ...
                            <br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              <strong>IMPORTANT:</strong>T he matches in this email are new matches since <strong>April 24th.</strong>
                              To view old matches, log into <a href='https://carpool.pulangmengundi.com'>our site</a>, and view your Rider or Driver listing.
                            </p>
                            <br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              If you have already been connected successfully through our platform,
