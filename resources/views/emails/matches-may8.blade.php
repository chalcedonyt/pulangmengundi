                          ...
                          <div style="font-size:12px;line-height:14px;color:#0D0D0D;font-family:Verdana;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              ...
                              <span style="line-height: 26px; font-size: 22px;">
                                <strong>LESS THAN 24 HOURS</strong> left to GE14! Have you found your carpool?
                              </span>
                            </p>
                            <br />
                            <br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              Whether you are a rider or driver, we encourage you to <strong>keep trying</strong> - contact as many people as you can, and do be flexible in arranging pick-ups and drop-offs.
                              We are all here as Malaysians helping Malaysians home.
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              <strong>Ideas:</strong>
                              <ul>
                            ...
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              For <strong>riders</strong>, please be safe. Give a family member or friend the information of your driver, travel plans, and the vehicle license plate. Arrange to check in with them regularly during the trip.
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              For <strong>drivers</strong>, be upfront about whether you want your riders to share costs before you confirm your trip. Please drive carefully.
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                ...
                <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;">
                  <div style="background-color: transparent; width: 100% !important;">
                    ...
                    <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                      ...
                      <div style="line-height:150%;color:#0D0D0D;font-family:Verdana; padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 30px;">
                          <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                            The matches in this email are new matches since <strong>May 5th.</strong>
