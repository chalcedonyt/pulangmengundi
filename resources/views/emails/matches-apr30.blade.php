...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f0ad4e">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #f0ad4e;width: 100%" cellpadding="0" cellspacing="0">
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #f0ad4e;"><![endif]-->
                  ...
                  <div style="background-color: transparent; width: 100% !important;">
                    ...
                    <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                      ...
                      <div align="center" class="img-container center  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                        <!-- <img class="center  autowidth " align="center" border="0" src="https://carpool.pulangmengundi.com/img/2df0f7f0-d25c-421a-9eb9-c72f2a36b7f8.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 280px"
                          width="280"> -->
                        @if ($matchedNeeds)
                        <img class="center  autowidth " align="center" border="0" src="https://carpool.pulangmengundi.com/img/carpool-rider-en.jpg" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 300px"
                          width="300">
                        @else
                        <img class="center  autowidth " align="center" border="0" src="https://carpool.pulangmengundi.com/img/carpool-driver-en.jpg" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 300px"
                          width="300">
                        @endif
                        <!--[if mso]></td></tr></table><![endif]-->
                      </div>
                          ...
                          <div style="font-size:12px;line-height:14px;color:#0D0D0D;font-family:Verdana;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              ...
                              <span style="line-height: 26px; font-size: 22px;">
                                <strong>EIGHT DAYS</strong> left to GE14! Have you found your carpool?
                              </span>
                            </p>
                            <br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                            ...
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              ...
                              through our platform or the various other initiatives, we know there are many who are still looking.
                            </p>
                            <br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              Whether you are a rider or driver, we encourage you to keep trying - contact as many people as you can, and do be flexible in arranging pick-ups and drop-offs.
                              We are all here as <strong>Malaysians helping Malaysians home</strong>.
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              We may also be starting <strong>Whatsapp groups</strong> for certain routes to help with arrangements. Let us know if you have any questions or suggestions!
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              If you have already been connected successfully through our platform, we are so happy for you! To stop receiving updates from us,
                              <strong>please</strong>
                              @if ($isDriver)
                              <a target='_blank' href="https://carpool.pulangmengundi.com/my-offers?show_close_dialog=1&utm_campaign=matchUpdate&utm_medium=email">update your listing status on your driver page</a>.
                              @else
                            ...
                            <br /></br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              Please check out these bus routes from Balik.UndiRabu, our strategic partner:
                            </p>
                      ...
                      <div align="center" class="img-container center  autowidth  " style="padding-right: 0px;  padding-left: 0px;">
                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px;line-height:0px;"><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                        <img class="center  autowidth " align="center" border="0" src="https://carpool.pulangmengundi.com/img/61ee23eb-4d60-48b6-8d56-4078a8d1b35d.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 150px"
                          width="150">
                        <!--[if mso]></td></tr></table><![endif]-->
                      </div>
                    ...
                    <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                      ...
                      <div style="line-height:150%;color:#0D0D0D;font-family:Verdana; padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 30px;">
                          <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                            The matches in this email are new matches since <strong>April 28th.</strong>
                            To view old matches, log into <a href='https://carpool.pulangmengundi.com'>our site</a>, and view your Rider or Driver listing.
                          </p>
                      </div>
                        ...
                        <div style="line-height:150%;color:#0D0D0D;font-family:Verdana; padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 30px;">
                          <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:Verdana;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                              ...
                              <br></p>
                            <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">&#160;<br></p>
                            <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                              <strong>Gender:</strong><br />
                              {{$need->gender}}<br /><br />
                              <strong>Travelling from:</strong><br>
                              {{$need->fromLocation->name}} ({{$need->fromLocation->locationState->name}})<br /><br />
                              <strong>Travelling to:</strong><br>
                              {{$need->pollLocation->name}} ({{$need->pollLocation->locationState->name}})<br /><br />
                        ...
                        <div style="line-height:150%;color:#0D0D0D;font-family:Verdana; padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 30px;">
                          <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:Verdana;text-align:left;">
                            ...
                            <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                              ...
                              <strong>Gender preference</strong><br />
                              {{$offer->gender_preference}}<br /><br />
                              @endif
                              <strong>Travelling from:</strong><br>
                              {{$offer->fromLocation->name}} ({{$offer->fromLocation->locationState->name}})<br /><br />
                              <strong>Travelling to:</strong><br>
                              ...
                              {{\Carbon\Carbon::parse($offer->correspondingOffer->leave_at)->format('D jS M Y, g:ia')}}<br /><br />
                              @endif
                      ...
                      <div class="">
                        ...
                        <div style="line-height:150%;color:#555555;font-family:Verdana; padding-right: 10px; padding-left: 10px; padding-top: 25px; padding-bottom: 10px;">
                          <div style="font-size:12px;line-height:18px;color:#555555;font-family:Verdana;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><em><span style="font-size: 18px; line-height: 27px;"><span style="color: rgb(51, 51, 51); line-height: 27px; font-size: 18px;"><span style="line-height: 27px; font-size: 18px;"></span><span style="color: rgb(0, 0, 0); line-height: 27px; font-size: 18px;">Thank you for using</span></span> </span></em></p>
                            <p
                              style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><em><span style="font-size: 18px; line-height: 27px;"><a style="color:#a8bf6f;color:#a8bf6f;text-decoration: none;" href="https://carpool.pulangmengundi.com/" target="_blank" rel="noopener">carpool.pulangmengundi.com</a></span></em>
                              <span
                                style="color: rgb(168, 191, 111); font-size: 14px; line-height: 21px;"></span>
                                </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                  ...
                  <div style="background-color: transparent; width: 100% !important;">
                    ...
                    <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                      ...
                      <div class="">
                        ...
                        <div style="color:#555555;line-height:120%;font-family:Verdana; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                          <div style="font-size:12px;line-height:14px;color:#555555;font-family:Verdana;text-align:left;">
                            ...
                            <tbody>
                              <tr style="vertical-align: top">
                                <td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                  <a href="https://www.facebook.com/pulangmengundi/" title="Facebook" target="_blank">
          <img src="https://carpool.pulangmengundi.com/img/facebook@2x.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
        </a>
                          ...
                          <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;Margin-right: 5px">
                            <tbody>
                              <tr style="vertical-align: top">
                                <td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                  <a href="https://twitter.com/pulangundi" title="Twitter" target="_blank">
          <img src="https://carpool.pulangmengundi.com/img/twitter@2x.png" alt="Twitter" title="Twitter" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
        </a>
                                  <div style="line-height:5px;font-size:1px">&#160;</div>
                                </td>
                              </tr>
                          ...
                          <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;Margin-right: 0">
                            <tbody>
                              <tr style="vertical-align: top">
                                <td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                  <a href="https://www.instagram.com/pulangundi/" title="Instagram" target="_blank">
          <img src="https://carpool.pulangmengundi.com/img/instagram@2x.png" alt="Instagram" title="Instagram" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
        </a>
                                  <div style="line-height:5px;font-size:1px">&#160;</div>
                                </td>
                              </tr>
                      ...
                      <div class="">
                        ...
                        <div style="line-height:120%;color:#a8bf6f;font-family:Verdana; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;">
                          <div style="font-size:12px;line-height:14px;color:#a8bf6f;font-family:Verdana;text-align:left;">
                            <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">www.pulangmengundi.com</p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                      </div>
