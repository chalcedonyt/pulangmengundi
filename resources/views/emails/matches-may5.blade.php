                          ...
                          <div style="font-size:12px;line-height:14px;color:#0D0D0D;font-family:Verdana;text-align:left;">
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              ...
                              <span style="line-height: 26px; font-size: 22px;">
                                <strong>FOUR DAYS</strong> left to GE14! Have you found your carpool?
                              </span>
                            </p>
                            <br />
                            <br />
                              ...
                              <ul>
                                <li>
                                    <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: left">
                                      If you are a <strong>rider</strong>, find other riders going your way, and rent a car or van together.
                                    </p>
                                </li>
                                <li>
                                  <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: left">
                                    If you are a <strong>driver</strong>, pick people up from other states on your way!
                                  </p>
                                </li>
                              </ul>
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                              We are starting <strong>Whatsapp groups</strong> for certain routes to help with arrangements. Let us know if you have any questions or suggestions!
                            </p><br /><br />
                            <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
